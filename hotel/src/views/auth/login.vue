  ...
  <form class="w-screen h-screen grid">
    <div class="grid bg-lightGreen p-4 place-self-center border-2 border-secondary rounded-xl">
      ...
      <div class="py-1 sm:py-4 px-6 sm:px-16 grid">
        <h1 class="text-3xl sm:text-4xl tracking-wider justify-self-center text-secondary font-bold font-bell">LOGIN</h1>
        ...
        <div class="flex justify-center">
          <RouterLink
            ...
            to="/auth/register"
          >
           No account yet? <span class="underline text-accent font-bell font-bold">Register here</span>
          </RouterLink>
        </div>
      </div>
